...
# 2. Define o caminho para a pasta do código-fonte C++. (CAMINHO AJUSTADO)
SOURCE_DIR="$SCRIPT_DIR/../../Algoritmos de validação/C++"

# --- NOMES DOS ARQUIVOS PARA O INSERTION SORT (C++) ---
SOURCE_FILE="validacao_insertion_sort.cpp"
EXECUTABLE_NAME="validacao_insertion_sort_cpp"
# ------------------------------------------------------
