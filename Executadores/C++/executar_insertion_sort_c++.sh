...
ARQUIVO_RESULTADOS="$DIRETORIO_BASE\\Resultados\\C++\\resultados_insertion_sort_c++.csv"

NOME_ARQUIVO_FONTE="insertion_sort.cpp"       
ARQUIVO_EXECUTAVEL="./insertionsort_exec"
LINGUAGEM="C++"            
